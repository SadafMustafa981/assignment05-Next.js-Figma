...
function Header () {
  return (
    <div className="bg-[#A29875] h-auto w-full text-[#FFFFFF] flex flex-col md:flex-row justify-between items-center px-4 md:px-9 py-4 md:space-4 md:space-y-0">
       {/* Logo */} 
       ...
       {/* Search Bar */}
       <div className="flex items-center bg-white rounded-full px-4 py-2 w-full max-w-xs md:max-w-md mx-4 md:mx-6 shadow-5m">
        <input
        type="text"
